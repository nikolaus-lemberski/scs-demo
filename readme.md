...
8. Call frontend-service to get a Hello message from frontend-service. Call path /backend on frontend-service to get a Hello message from backend. If something goes wrong and circuit breaker takes over, check logs and service registry dashboard.
